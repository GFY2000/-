$(document).ready(function () {
    // 模拟的日志数据
    var logs = [
        { title: "工作日志(3) ", link: "/log_tz/log1.html", time: "2022年12月12日", author: "郭方一、盛伟" },
        { title: "工作日志(2) ", link: "/log_tz/log1.html", time: "2022年12月12日", author: "盛伟、郭方一" },
        { title: "工作日志(1) ", link: "/log_tz/log1.html", time: "2022年12月12日", author: "郭方一、盛伟" },
    ];
